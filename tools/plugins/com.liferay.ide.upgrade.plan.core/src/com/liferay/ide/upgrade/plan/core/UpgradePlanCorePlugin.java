...
public class UpgradePlanCorePlugin extends Plugin {
	...
	public static IUpgradePlanOutline getOutline(String key) {
		IPreferencesService preferencesService = Platform.getPreferencesService();

		String outline = preferencesService.getString(UpgradePlanCorePlugin.ID, key, "", null);

		if (CoreUtil.isNullOrEmpty(outline)) {
			return null;
		}

		String[] outlineArray = StringUtil.stringToArray(outline, ",");

		return new UpgradePlanOutline(outlineArray[0].trim(), outlineArray[1].trim());
	}
